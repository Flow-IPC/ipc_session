 ...
 *       - Client_session::async_connect() shall check this file immediately to know to which server process --
...
public:
   ...
   * features.
   *
   * The advanced capabilities complement/mirror the ones on Client_session_mv::async_connect() (advanced overload);
   ...
   *
   * The metadata payload you may wish to load to emit to the opposing `Client_session::async_connect()` may
